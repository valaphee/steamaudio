...
*/
IPLAPI IPLAudioEffectState IPLCALL iplPanningEffectApply(IPLPanningEffect effect, const IPLPanningEffectParams* params, const IPLAudioBuffer* in, IPLAudioBuffer* out);
